...
import { Check, Copy, Plug, GitBranch, Server, ExternalLink, Key, Search, X, Trash2, BookmarkPlus, Pencil, Palette, Sun, Moon, Monitor, BookOpen, Plus, Save, Settings2, Code, Shield, Cpu, Wrench, ChevronDown, ChevronRight, Info } from "lucide-solid"
...
export function Settings() {
  ...
  const getInitialTab = () => {
    ...
    const validTabs = ["providers", "git", "mcp", "prompts", "instructions", "config", "appearance"]
